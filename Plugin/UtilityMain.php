...
namespace Baniwal\OwlCarouselSlider\Plugin;
...
class UtilityMain
{
    ...
    /** @var  \Baniwal\Backend\Model\License */
     ...
     * @param \Baniwal\Backend\Model\License $licenseModel
     */
    public function __construct(
        \Magento\Backend\Model\Auth $auth,
        \Magento\Framework\App\ResponseInterface $response,
        // \Baniwal\Backend\Model\License $licenseModel,
    ...
    )
    {
        ...
        if ($this->_auth->isLoggedIn() && $this->_isPathRestrictionRequired() && $request->isDispatched()) {
