...
namespace Baniwal\OwlCarouselSlider\Block\Adminhtml\Banner\Edit\Tab;
    ...
    implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     * slider factory.
     *
     * @var \Baniwal\OwlCarouselSlider\Model\SliderFactory
     */
    protected $_sliderFactory;

    /**
     * @var \Baniwal\OwlCarouselSlider\Model\Banner
     */
     ...
     * @param \Baniwal\OwlCarouselSlider\Model\SliderFactory                         $sliderFactory
    ...
    public function __construct(
        ...
        \Baniwal\OwlCarouselSlider\Model\Banner $bannerModel,
        \Baniwal\OwlCarouselSlider\Model\SliderFactory $sliderFactory,
    ...
    protected function _prepareLayout()
    {
        ...
        \Magento\Framework\Data\Form::setFieldsetElementRenderer(
            $this->getLayout()->createBlock(
                'Baniwal\OwlCarouselSlider\Block\Adminhtml\Form\Renderer\Fieldset\Element', $this->getNameInLayout()
                .'_fieldset_element'
            )
        );
    ...
    protected function _prepareForm()
    {
        ...
        /**
         * @var \Baniwal\OwlCarouselSlider\Model\Banner $bannerModel
         */
        ...
        if ($slider->getId()) {
            $elements['slider_id'] = $fieldset->addField(
                ...
                [
                    ...
                    'note'    => 'You can assign the same banner to multiple sliders<br/>Select to which Slider you wish to assign current banner. The assignments of banner can be 
            ...
            $elements['slider_id'] = $fieldset->addField(
                ...
                [
                    ...
                    'note'    => 'You can assign the same banner to multiple sliders.<br/>Select to which Slider you wish to assign current banner. The assignments of banner can be done also later from Sliders Manager > Edit or Add New 
                    Slider > Slider Banners grid.',
                ]
            );
        }
     ...
     *
     * @return \Baniwal\OwlCarouselSlider\Model\Banner
     */
